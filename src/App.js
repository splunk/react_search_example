...
function App(props) {
  ...
  const [columnSearchResultsColumns, setColumnSearchResultsColumns] =
    useState();
  ...
  const [splunkSearchColumnPostProcess, setSplunkSearchColumnPostProcess] =
    useState(
  ...
  const [singleValueSearchResultsFields, setSingleValueSearchResultsFields] =
    useState();
  //Columns for Single Value
  const [singleValueSearchResultsColumns, setSingleValueSearchResultsColumns] =
    useState();
  //Seconds to Complete for Single Value
  const [singleValueSeondsToComplete, setSingleValueSecondsToComplete] =
    useState();
  ...
  const [singleValueAppendPostProcess, setSingleValueAppendPostProcess] =
    useState(false);
  ...
  const [
    ...
    setSplunkSearchSingleValuePostProcess,
  ] = useState('| search sourcetype="splunkd"');
    ...
    switch (eventType) {
      case "submit":
        ...
        createJob(
          ...
          searchOptions.earliest,
          searchOptions.latest
        )
          .then((data) => data)
          .then((sidJob) => {
            setSidFunc(sidJob);
    ...
    >
      ...
      >
        <header className="App-header">
          ...
          <P>
            This app will show you how to query Splunk from a remote webapp
            using our Splunk UI Toolkit in React. It uses a couple of packages
            listed below:{" "}
          </P>
